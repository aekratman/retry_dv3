  ...
  "node_modules/hjson/lib/hjson-parse.js"(exports, module) {
    ...
    module.exports = function(source, opt) {
      ...
      function array() {
        ...
        try {
          if (keepComments) comments = common.createComment(array2, { a: [] });
          next();
          cAt = at;
          white();
      ...
      function object(withoutBraces) {
        ...
        var comments, cAt, nextComment;
        try {
          if (keepComments) comments = common.createComment(object2, { c: {}, o: [] });
          if (!withoutBraces) {
            next();
            cAt = at;
          } else cAt = 1;
    ...
    module.exports = function(data, opt) {
      ...
      function quote(string, gap2, hasComment, isRootObject) {
        ...
        if (quoteStrings || hasComment || needsQuotes.test(string) || common.tryParseNumber(string, true) !== void 0 || startsWithKeyword.test(string)) {
          ...
          else if (!needsEscapeML.test(string) && !isRootObject && multiline) return mlString(string, gap2);
      ...
      function str(value, hasComment, noIndent, isRootObject) {
        ...
        function makeComment(str2, prefix2, trim) {
          ...
          if (trim && i3 > 0) str2 = str2.substr(i3);
          if (i3 < len) return prefix2 + wrap(token.rem, str2);
          else return str2;
        }
        ...
        switch (typeof value) {
          ...
          case "object":
            ...
            var comments2;
            if (keepComments) comments2 = common.getComment(value);
            ...
            if (isArray) {
              for (i2 = 0, length = value.length; i2 < length; i2++) {
                ...
                if (comments2 && c[1]) partial.push(makeComment(c[1], ca ? " " : "\n", ca));
              }
              if (length === 0) {
                if (comments2 && comments2.e) partial.push(makeComment(comments2.e[0], "\n") + eolMind);
              ...
              if (partial.length === 0) res2 = wrap(token.arr, "");
                ...
                if (cpartial) {
                  cres = cpartial.join(" ");
                  if (cres.length - cwrapLen <= condense) res2 = wrap(token.arr, cres);
                }
              }
            } else {
              ...
              if (partial.length === 0) {
                ...
                if (cpartial) {
                  cres = cpartial.join(" ");
                  if (cres.length - cwrapLen <= condense) res2 = wrap(token.obj, cres);
                }
              }
            }
            gap = mind;
